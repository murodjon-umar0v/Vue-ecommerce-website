    ...
    <v-card flat tile class="black white--text py-12 px-5" width="100%">
      <v-row>
        <v-col cols="12" sm="4">
          ...
          <v-card class="grey--text pt-0">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. <br />
            A ad laudantium eos similique modi adipisci!
          </v-card>
        ...
        <v-col cols="12" sm="2">
          ...
          <v-card-text class="grey--text"> Sustainability </v-card-text>
          <v-card-text class="grey--text mt-n4"> Service </v-card-text>
          <v-card-text class="grey--text mt-n4">
            CA Supply Chain Acts
          </v-card-text>
        </v-col>
        <v-col cols="12" sm="4">
          ...
          <v-card-text class="grey--text mt-4"> Payment Methods: </v-card-text>
          <v-toolbar flat color="transparent">
            <v-spacer></v-spacer>
